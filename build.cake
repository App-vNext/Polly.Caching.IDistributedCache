...
var projectName = "Polly.Caching.IDistributedCache";
    ...
    .Does(() =>
{
    ...
    var replacedFiles = ReplaceRegexInFiles("./src/Polly.Caching.IDistributedCache.NetStandard11/Properties/AssemblyInfo.cs", "AssemblyVersion[(]\".*\"[)]", "AssemblyVersion(\"" + assemblySemVer +"\")");
...
Task("__RunDotnetTests")
    .Does(() =>
{
    DotNetCoreTest("./src/Polly.Caching.IDistributedCache.NetStandard11.Specs/Polly.Caching.IDistributedCache.NetStandard11.Specs.csproj", new DotNetCoreTestSettings {
